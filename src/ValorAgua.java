...
public class ValorAgua {
   public static void main(String args[]) {
       ...
       final double valor1 = 1.20, valor2 = 1.50, valor3 = 2.00, valor4 = 2.50;
       ...
       } else if (quan_Consumida > 11 && quan_Consumida < 20) {
           valorConsumido = quan_Consumida * valor2;
           System.out.println("\nO valor consumido em metros cubicos é: " + valorConsumido);
       } else if (quan_Consumida > 20 && quan_Consumida < 30) {
           valorConsumido = quan_Consumida * valor3;
           System.out.println("\nO valor consumido em metros cubicos é: " + valorConsumido);
       } else {
           valorConsumido = quan_Consumida * valor4;
           System.out.println("\nO valor consumido em metros cubicos é: " + valorConsumido);
       }
